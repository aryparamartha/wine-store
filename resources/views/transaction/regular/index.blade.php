...
@section('title', 'WineryApp - Regular Transaction')
                ...
                <div class="card-body">
                    <div class="row mb-20">
                        <div class="col-md-6 col-6">
                            <h6 class="card-title">Regular Transaction Data</h6>
                        </div>
                        <div class="col-md-6 col-6">
                            <div class="flt-right">
                                <a class="btn btn-success btn-icon-text btn-edit-profile" href="{{route('tx.regular.new')}}" id="btn-add-breakage" >
                                    <i data-feather="plus" class="btn-icon-prepend"></i> Add Regular Transaction
                                </a>
                            </div>  
                        </div>
                    </div>          
