...
@section('title', 'WineryApp - Edit Receiving')
...
@section('content')
<form name="memberForm" class="forms-sample" action="{{route('receiving.update', $receiving)}}" method="POST">
    @csrf
        ...
        <div class="col-md-3 grid-margin">
            <div class="row">
                <div class="col-md-12 grid-margin">
                    <div class="card">
                        <div class="card-body">
                            <h4 class="card-title">Edit Receiving</h4>
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <label for="invoice_id" class="w-100">Receiving No</label>
                                        <input value="{{$receiving->invoice_id}}" name="invoice_id" type="text" class="w-100 form-control" required />
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select id="supplier_id" name="supplier_id" class="w-100 form-control" required>
                                            ...
                                            <?php $selected = ($receiving->supplier_id==$supplier->id)?"selected":""; ?>
                                            <option {{$selected}} value="{{$supplier->id}}">{{$supplier->id}} - {{$supplier->name}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input value="{{$receiving->receiving_date}}" name="receiving_date" type="date" class="w-100 form-control" required />
                                    </div>
                                </div>
                            </div>
                        </div>
